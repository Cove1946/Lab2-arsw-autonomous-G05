...
public final class WarehouseMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // The coordinator blocks until every robot thread has terminated (Thread.join()).
        // join() also establishes a happens-before edge, so the snapshot below observes
        // the final values written by the workers instead of stale cached ones.
